package cn.edu.gdmec.a07150810.mymap;
...
public class MainActivity extends AppCompatActivity {
        ...
        OnGetPoiSearchResultListener getPoiSearchResultListener = new OnGetPoiSearchResultListener() {
            ...
            public void onGetPoiResult(PoiResult poiResult) {
                ...
                if(poiResult.error == SearchResult.ERRORNO.NO_ERROR){
                    ...
                    overlay.zoomToSpan();
                    Toast.makeText(
                            MainActivity.this,"总共查到" + poiResult.getTotalPoiNum() + "个兴趣点，分为"
            ...
            public void onGetPoiDetailResult(PoiDetailResult poiDetailResult) {
                if(poiDetailResult.error != SearchResult.ERRORNO.NO_ERROR){
                    Toast.makeText(MainActivity.this,"抱歉，没找到结果",Toast.LENGTH_SHORT).show();
                }else {
    ...
    public class MyPoiOverlay extends com.baidu.mapapi.overlayutil.PoiOverlay{
